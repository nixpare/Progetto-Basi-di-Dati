...
<body class="stud">
	...
	<div class="container my-4">
		...
		<p>Filtra i Docenti per cognome</p>
		<form class="my-3" action="">
			<input type="text" name="doc" placeholder="Cognome" <?php if (!empty($_GET)) {
				if (isset($_GET['doc'])) {
					echo 'value="' . urldecode($_GET['doc']). '"';
				}
			} ?> >
	...
	<div class="container mt-5">
		...
		<table>
			...
			<tbody>
				...
				<tr>
					<td><?php echo $doc['cognome'] ?></td>
					<td><?php echo $doc['nome'] ?></td>
					<td><?php echo $doc['email'] ?></td>
					<td><a class="btn" href="<?php echo '/segreteria/docenti/gestisci.php?doc=' . $doc['email'] ?>">Gestisci</a></td>
				</tr>
				<?php } } ?>
			</tbody>
		</table>
	...
	<div class="container mt-5">
		...
		<h4 class="highlight">Crea docente</h4>
				...
				<tr>
					...
					<td>
						<div class="password-eye-container">
							<input class="px-0" type="password" name="password">
