<?php
	...
	if ($result['error'] != '') {
		...
		$err_message = 'Errore creatione studente';
	}
...
<body class="stud">
	...
	<div class="container my-4">
		...
		<p>Filtra gli Studenti per il cognome</p>
		<form class="my-3" action="">
			<input type="text" name="stud" placeholder="Filtro" <?php if (!empty($_GET)) {
				if (isset($_GET['stud'])) {
		...
		<table>
			...
			<tbody>
				...
				<tr>
					...
					<td><?php echo ucfirst($stud['email']) ?></td>
